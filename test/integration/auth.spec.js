...
describe('dynarouter', function () {
    describe('auth', function () {
        ...
        it('should throw an AccessDeniedError and return status 403 (GET)', function(done) {
            request
                .get('/test/a/6')
                .expect(403)
                .end((err, res) => {
        ...
        it('should throw an AccessDeniedError and return status 403 (PUT)', function(done) {
            request
                .put('/test/a/6')
        ...
        it('should throw an AccessDeniedError and return status 403 (POST)', function(done) {
            request
                .post('/test')
                .send(testModel.object)
                .expect(403)
        ...
        it('should throw an AccessDeniedError and return status 403 (PATCH)', function(done) {
        ...
        it('should throw an AccessDeniedError and return status 403 (DELETE)', function(done) {
            request
                .del('/test/a/4')
                .expect(403)
                .end((err, res) => {
        ...
        it('should throw an AccessDeniedError and return status 403 (QUERY)', function(done) {
            request
                .get('/test')
                .expect(403)
                .end((err, res) => {
